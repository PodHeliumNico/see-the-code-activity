...
export const welcomeUser = async () => {
  ...
  await morpheus();
  await promptUser("Throughout human history, we have been dependent on machines to survive.");
  await morpheus();
  ...
  await wait(2000);
  await morpheus();
  await promptUser("We've brought you here because we need someone like you.");
  await neo();
  ...
  await neo();
  await promptUser("They've recently gotten their hands on a new weapon.");
  await neo();
  ...
  await wait(2000);
  await neo();
  await promptUser("This may seem sudden to you, but for us -- we know all about you.");
  await morpheus();
  await promptUser("We know that when it comes to JavaScript... you're The One.");
  await neo();
