...
export const tutorialRound1 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhich line of code will be executed first?\x1B[0m",
        true
    );
};
...
export const tutorialRound2 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhich line of code will execute next?\x1B[0m",
        true
    );
};
...
export const tutorialRound3 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhich line of code will execute last?\x1B[0m",
        true
    );
};
...
export const tutorialRound4 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhich line of code will execute first?\x1B[0m",
        true
    );
};
...
export const tutorialRound5 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat is the length of the trainingRoutines array?\x1B[0m",
        true
    );
};
...
export const tutorialRound6 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat line executes the train function?\x1B[0m",
        true
    );
};
...
export const tutorialRound7 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat is the next line of code that executes?\x1B[0m",
        true
    );
};
...
export const tutorialRound10 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mIf a skill is added to the agent.skills array, enter its name without quotes.\x1B[0m"
    );
    await promptUser(
        '\x1B[1;32mIf no skill is added, enter "nothing" without quotes.\x1B[0m',
        true
    );
};
...
export const tutorialRound11 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat is the maximum number of times that this loop could run?\x1B[0m",
        true
    );
};
...
export const tutorialRound12 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat is the length of the agent.skills array at the end of the loop?\x1B[0m",
        true
    );
};
...
export const tutorialRound13 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat is the name of the last skill that was added to the agent.skills array?\x1B[0m",
        true
    );
};
...
export const tutorialRound14 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mDoes another line of code execute after exiting the train function? (y/n)\x1B[0m",
        true
    );
};
...
export const tutorialRound18 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat line will execute the controlHumans function?\x1B[0m",
        true
    );
};
...
export const tutorialRound21 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mDoes the variable isZionFound represent the searchForZion function? (y/n)\x1B[0m",
        true
    );
};
...
export const tutorialRound23 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat line does the return statement return to?\x1B[0m",
        true
    );
};
...
export const tutorialRound24 = async () => {
    ...
    await promptUser(
        "\x1B[1;32mWhat line of code have the Machines written incorrectly?\x1B[0m",
        true
    );
};
